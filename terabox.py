...
async def handle_message(client: Client, message: Message):
    ...
    status_message = await message.reply_text("🔄 Processing Terabox link and starting download...")
    ...
    try:
        ...
        if file_size > SPLIT_SIZE:
            status_message.edit_text(f"✂️ Splitting file {download.name} ({format_size(file_size)})")
